...
contract MarketDataTest is BaseMarketTest {
  ...
  function test_HooksInstanceDataFill_readsManagedProviderAdministration() external {
    ...
    assertEq(providerData.pendingAdministrator, newAdministrator, 'provider pending administrator');
  }
  ...
  function test_getLenderWithdrawalStatusForNonexistentBatch() external view {
    ...
    WithdrawalBatchDataWithLenderStatus memory data = lens.getWithdrawalBatchDataWithLenderStatus(
      address(market),
      unknownExpiry,
      alice
    );
