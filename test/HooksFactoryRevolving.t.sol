...
contract HooksFactoryRevolvingTest is Test, Assertions {
  ...
  function setUp() public {
    ...
    (marketTemplate, marketInitCodeHash) = _storeMarketInitCode();
  ...
  function test_deployHooksInstance() external {
    ...
    address[] memory hooksInstances = hooksFactoryRevolving.getHooksInstancesForBorrower(
      address(this)
    );
  ...
  function test_getMarketsForHooksTemplateAndInstance_Pagination() external {
    ...
    {
      address[] memory templateSlice1 = hooksFactoryRevolving.getMarketsForHooksTemplate(
        hooksTemplate,
        1,
        2
      );
    ...
    {
      address[] memory templateClamped = hooksFactoryRevolving.getMarketsForHooksTemplate(
        hooksTemplate,
        0,
        10
      );
    ...
    {
      address[] memory templateEmptyAtEnd = hooksFactoryRevolving.getMarketsForHooksTemplate(
        hooksTemplate,
        2,
        2
      );
    ...
    {
      address[] memory templateEmptyInverted = hooksFactoryRevolving.getMarketsForHooksTemplate(
        hooksTemplate,
        2,
        1
      );
    ...
    {
      address[] memory templateEmptyPastEnd = hooksFactoryRevolving.getMarketsForHooksTemplate(
        hooksTemplate,
        3,
        10
      );
    ...
    {
      address[] memory instanceSlice0 = hooksFactoryRevolving.getMarketsForHooksInstance(
        hooksInstance,
        0,
        1
      );
    ...
    {
      address[] memory instanceSlice1 = hooksFactoryRevolving.getMarketsForHooksInstance(
        hooksInstance,
        1,
        2
      );
    ...
    {
      address[] memory instanceClamped = hooksFactoryRevolving.getMarketsForHooksInstance(
        hooksInstance,
        0,
        10
      );
    ...
    {
      address[] memory instanceEmptyAtEnd = hooksFactoryRevolving.getMarketsForHooksInstance(
        hooksInstance,
        2,
        2
      );
    ...
    {
      address[] memory instanceEmptyInverted = hooksFactoryRevolving.getMarketsForHooksInstance(
        hooksInstance,
        2,
        1
      );
    ...
    {
      address[] memory instanceEmptyPastEnd = hooksFactoryRevolving.getMarketsForHooksInstance(
        hooksInstance,
        3,
        10
      );
