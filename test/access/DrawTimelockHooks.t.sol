...
contract DrawTimelockHooksTest is MarketConfigMatrix {
  ...
  DrawTimelockHooks internal hooksInstance;
  ...
  function setUp() public override {
    ...
    timelockTemplate = LibStoredInitCode.deployInitCode(type(DrawTimelockHooks).creationCode);
  ...
  function _deploy(
    ...
    hooksInstance = DrawTimelockHooks(instance);
