...
contract CommitmentScheduleHooksTest is MarketConfigMatrix {
  uint256 internal constant DEPOSIT = 1_000_000e18;

  address internal scheduleTemplate;
  CommitmentScheduleHooks internal hooksInstance;
  ...
  function setUp() public override {
    ...
    scheduleTemplate = LibStoredInitCode.deployInitCode(type(CommitmentScheduleHooks).creationCode);
  ...
  function _deploy(bytes memory hooksData) internal {
    ...
    hooksInstance = CommitmentScheduleHooks(instance);
