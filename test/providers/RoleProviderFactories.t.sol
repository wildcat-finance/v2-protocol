...
contract RoleProviderFactoriesTest is TestKernel {
  ...
  function setUp() external {
    ...
    balanceToken = FactoryBalanceTokenMock(
      _deployCode('test/mocks/RoleProviderFactoryMocks.sol:FactoryBalanceTokenMock')
    );
    ...
    erc721Token = FactoryERC165TokenMock(
      _deployCode(
        'test/mocks/RoleProviderFactoryMocks.sol:FactoryERC165TokenMock',
    ...
    alternateCaller = RoleProviderFactoryCaller(
      _deployCode('test/mocks/RoleProviderFactoryMocks.sol:RoleProviderFactoryCaller')
    );
  }
