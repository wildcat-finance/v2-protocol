...
contract HooksConfigTest is TestKernel {
  ...
  function setUp() external {
    hooks = HooksConfigTarget(
      _deployCode('test-next/mocks/HooksConfigTarget.sol:HooksConfigTarget')
    );
    caller = HooksConfigCaller(
      _deployCode('test-next/mocks/HooksConfigCaller.sol:HooksConfigCaller')
    );
    shortReturnHooks = _deployCode(
      'test-next/mocks/HooksConfigTarget.sol:HooksConfigShortReturnTarget'
    );
  }
