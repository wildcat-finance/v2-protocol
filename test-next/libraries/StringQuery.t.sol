...
contract StringQueryTest is TestKernel {
  ...
  function setUp() external {
    bytes32Metadata = Bytes32Metadata(
      _deployCode('test-next/libraries/StringQuery.t.sol:Bytes32Metadata')
    );
    stringMetadata = StringMetadata(
      _deployCode('test-next/libraries/StringQuery.t.sol:StringMetadata')
    );
    longStrings = LongStrings(_deployCode('test-next/libraries/StringQuery.t.sol:LongStrings'));
    badStrings = BadStrings(_deployCode('test-next/libraries/StringQuery.t.sol:BadStrings'));
    malformedStringMetadata = MalformedStringMetadata(
      _deployCode('test-next/libraries/StringQuery.t.sol:MalformedStringMetadata')
    );
    trailingStringMetadata = TrailingStringMetadata(
      _deployCode('test-next/libraries/StringQuery.t.sol:TrailingStringMetadata')
    );
  }
